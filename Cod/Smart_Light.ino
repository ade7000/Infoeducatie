...
String nume ;
bool informatii_introduce = 0; 




uint8_t pixel, dinapoi; 
byte  red, green, blue, timp;
byte mod_aprindere;

bool negru = 1;
bool  alb, fade_in_fade_out, culoare, up_down, ora;
bool  alb_ora, negru_ora, fade_in_fade_out_ora, culoare_ora; 
bool adunare_punctaj = true ; 

bool culoare_buton;
byte ora_off, ora_on = 0;
...
void setup(void) {
  ...
  */
  ...
  wifiManager.autoConnect("Go to 192.168.4.1");
